...
<form class="form-horizontal" method="GET" action="{{ url('/phatminh_update')}}">
...
<input type="hidden" name="ID" value="{{$phatminh->IID}}">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="ngaycongbo">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="ngaycap">
